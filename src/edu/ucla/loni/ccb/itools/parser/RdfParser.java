...
public class RdfParser extends JdomResourceHelper {
	...
	private static final String RESOURCES = "RDF";
	private static final String RESOURCE = "Resource_Description";

	private static final String PROP_NAME = "resource_name";
	private static final String PROP_DESCRIPTION = "description";
	private static final String PROP_AUTHORS = "contact_person";
	private static final String PROP_AUTHORS_EMAIL = "contact_person_email";
	private static final String PROP_KEYWORDS = "keywords";
	private static final String PROP_TYPE = "resource_type";
	private static final String PROP_ORGANIZATION = "organization";
	private static final String PROP_URL = "URL";
	private static final String PROP_DATAINPUT = "data_input";
	private static final String PROP_DATAOUTPUT = "data_output";
	private static final String PROP_PLATFORMS = "platforms";
	private static final String PROP_LICENSE = "license";
	private static final String PROP_VERSION_INFORMATION = "version_information";
	private static final String PROP_LANGUAGE = "language";
	private static final String PROP_BYLINE = "byline";
	private static final String PROP_CENTER = "center";
	private static final String PROP_VERSION_INFORMATIONL = "Version_Information";
	private static final String PROP_RELEASE_DATE = "release_date";
	private static final String PROP_VERSION = "version";
	private static final String PROP_STAGE = "development_stage";

	private static Map<String, String> keysOtherNames = new HashMap<String, String>();
...
//		keysOtherNames.put(PROP_URL, Descriptor.PROP_URL);
	...
	public NcbcResource jdom2Resource(Element ele) {
		...
		for (Element prop : getChildren(ele)) {
			...
			if (name.equals(PROP_CENTER) || name.equals(PROP_ORGANIZATION)) {
				...
				ontology
						.append(((Element) prop.getChildren().get(0)).getName());
			} else {
	...
	private static String getProperty(NcbcResource rsc, String key) {
		return rsc.getProperty(keysOtherNames.get(key));
	}
	...
	public static Element resouce2Jdom(NcbcResource rsc) {
		...
		for (String name : keysOtherNames.keySet()) {
			...
			if (name.equals(PROP_TYPE)) {
				...
				for (int n = 0; n < strs.length; n++) {
					Element ontology = new Element(strs[n].trim(), NS_BRO);
