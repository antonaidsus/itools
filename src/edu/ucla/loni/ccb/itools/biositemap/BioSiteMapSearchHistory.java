...
public class BioSiteMapSearchHistory {
	static ArrayList<SearchSummary> searchHistory = new ArrayList<SearchSummary>();
	static HashMap<String, BioSiteMapSearchRecord> bioSiteMapResearchRecords = new HashMap<String, BioSiteMapSearchRecord>();

	BioSiteMapSearchRecord bioSiteMap; // used only by parser.

	public static Collection<BioSiteMapSearchRecord> getBioSiteMapResearchRecords() {
		return bioSiteMapResearchRecords.values();
	}

	public static void addBioSiteMapResearchRecord(BioSiteMapSearchRecord record) {
	...
	public boolean addOneResult(String searchTime, String name, String url,
		...
		BioSiteMapSearchRecord record = (BioSiteMapSearchRecord) bioSiteMapResearchRecords
				.get(name);
		if (record == null) {
	...
	public static ArrayList<SearchSummary> getSummaries() {
