	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd.equals(UPDATE)) {
			...
			if (cmd.equals(PROMOTION)) {
				...
				MainFrame.getContent().getStandardResourceDisplayer()
						.addResource(rsc);
				MainFrame.getContent().getSandBoxDisplayer()
						.getResourceViewer().setData(new ArrayList(0));
			} else if (cmd.equals(DEMOTION)) {
				rsc.setInSandBox(true);
				MainFrame.getContent().getSandBoxDisplayer().addResource(rsc);
				MainFrame.getContent().getStandardResourceDisplayer()
						.getResourceViewer().setData(new ArrayList(0));
			}
