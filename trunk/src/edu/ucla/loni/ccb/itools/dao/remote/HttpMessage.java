...
public class HttpMessage {
  ...
  public InputStream sendPostMessage(Properties args) throws IOException {
	...
	if (ProxyServer.s_cookie == null) {
		String cookie = con.getHeaderField("set-cookie");
		if (cookie != null) {
			ProxyServer.s_cookie = ProxyServer.parseCookie(cookie);
			ProxyServer.LOGGER.debug("sessionID=" + ProxyServer.s_cookie);
		}
	}
  ...
  public void setCookie(String namevalue) {
	    if (headers == null) {
	      ...
	      String existingCookies = (String) headers.get("Cookie");
	      if (existingCookies == null) {
	        setHeader("Cookie", namevalue);
	      }
	      else {
	        setHeader("Cookie", existingCookies + "; " + namevalue);
	      }
